...
from dshow.comtypes import COMError, ReturnHRESULT, instancemethod, _encode_idl, IPersist
from dshow.comtypes.errorinfo import ISupportErrorInfo, ReportException, ReportError
...
class LocalServer(object):
    ...
    def run_sta(self):
        from dshow.comtypes import messageloop
        messageloop.run()

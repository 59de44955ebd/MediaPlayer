import ctypes
import dshow.comtypes.automation
import dshow.comtypes.typeinfo
import dshow.comtypes.client

from dshow.comtypes import COMError, IUnknown, _is_object
import dshow.comtypes.hresult as hres
...
class MethodCaller:
    ...
    def __getitem__(self, *args):
        return self._obj._comobj.Invoke(self._id, *args,
                                        **dict(_invkind=dshow.comtypes.automation.DISPATCH_PROPERTYGET))

    def __setitem__(self, *args):
        if _is_object(args[-1]):
            self._obj._comobj.Invoke(self._id, *args,
                                        **dict(_invkind=dshow.comtypes.automation.DISPATCH_PROPERTYPUTREF))
        else:
            self._obj._comobj.Invoke(self._id, *args,
                                        **dict(_invkind=dshow.comtypes.automation.DISPATCH_PROPERTYPUT))
...
class _Dispatch(object):
    ...
    def __enum(self):
        ...
        return e.QueryInterface(dshow.comtypes.automation.IEnumVARIANT)
    ...
    def __getattr__(self, name):
        ...
        flags = dshow.comtypes.automation.DISPATCH_PROPERTYGET
        try:

...
from dshow.comtypes import GUID, STDMETHOD, HRESULT, IUnknown
...
class IClassFactory(IUnknown):
    ...
    def CreateInstance(self, punkouter=None, interface=None, dynamic=False):
        if dynamic:
            ...
            realInterface = dshow.comtypes.automation.IDispatch
        ...
        if dynamic:
            ...
            return dshow.comtypes.client.GetBestInterface(obj)

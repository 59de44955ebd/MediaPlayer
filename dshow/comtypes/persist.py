...
from dshow.comtypes import GUID, IUnknown, COMMETHOD, HRESULT, dispid, IPersist
from dshow.comtypes.automation import VARIANT, tagEXCEPINFO
...
from dshow.comtypes import COMObject
